...
var SolvedComponent = /** @class */ (function () {
    function SolvedComponent(UserService, router, route, ChallegerService) {
    ...
    SolvedComponent.prototype.getAlternatives = function (question) {
        ...
        this.ChallegerService.getAlternatives(question).subscribe(function (data) {
            ...
            _this.UserService.getSkils(localStorage.getItem("id")).subscribe(function (skils) {
                _this.skils = skils;
            });
            _this.UserService.getUser(localStorage.getItem("id")).subscribe(function (user) {
                _this.userAtual = user;
            });
        });
    };
...
var QuestionarioComponent = /** @class */ (function () {
    function QuestionarioComponent() {
    }
